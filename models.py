...
class FlowNet2SDMulti(FlowNetSD.FlowNetSDMulti):
    def __init__(self, args, batchNorm=False, div_flow=20):
        super(FlowNet2SDMulti,self).__init__(args, batchNorm=batchNorm)
        self.rgb_max = args.rgb_max
        self.div_flow = div_flow
...
class FlowNet2SDMultiTwoOutput(FlowNetSD.FlowNetSDMultiTwoOutput):
    def __init__(self, args, batchNorm=False, div_flow=20):
        super(FlowNet2SDMultiTwoOutput,self).__init__(args, batchNorm=batchNorm)
        self.rgb_max = args.rgb_max
        self.div_flow = div_flow
